...
def setup_simulation():
    ...
    robot_id = p.loadURDF("franka_panda/panda.urdf", [-0.3, 0.0, 0.62], useFixedBase=True)

    # Các object
    apple = create_item([1.005, -0.3, 0.65], 'cylinder', [0.025, 0.1], [1, 0, 0, 1])
    teddy_bear = create_item([1.005, 0.2, 0.65], 'cylinder', [0.025, 0.1], [0.25, 0.25, 0, 1])

    cake = create_item([0.3, -0.2, 0.65], 'cylinder', [0.025, 0.1], [1, 1, 0, 1])
    toy_car = create_item([0.4, 0.1, 0.65], 'cylinder', [0.025, 0.1], [0, 0, 1, 1])
