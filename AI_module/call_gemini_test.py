...
("robot2", "pick yellow_cube_2", "node[11]"),
("robot3", "pick red_cube_2", "node[12]"),
("robot1", "pick green_cube_3", "node[13]"),
("robot2", "place yellow_cube_2 in yellow_bowl", "node[14]"),
("robot3", "place red_cube_2 in red_bowl", "node[15]"),
("robot1", "place green_cube_3 in green_bowl", "node[16]")
]
